...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 04 juil. 2022 à 16:38
...
(10, 15, 15, 1, 1, 1, 4, '7', '2022-06-30 14:30:48'),
(11, 17, 16, 1, 1, 1, 10, '8', '2022-06-30 14:30:48'),
(12, 18, 18, 1, 1, 1, 11, '9', '2022-06-30 14:30:48');
...
CREATE TABLE `t_d_savfile_svf` (
  ...
  `SVF_Product` varchar(1024) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Déchargement des données de la table `t_d_savfile_svf`
--

INSERT INTO `t_d_savfile_svf` (`SVF_ID`, `SVF_COMM`, `SVF_CREATIONTIME`, `SVF_IP`, `USR_ID`, `OHR_ID`, `SVL_ID`, `DGC_ID`, `UTY_ID`, `SVF_Product`) VALUES
(1, 'Oui', '2022-06-28 10:45:28', NULL, 1, 2, 3, 4, 4, '6'),
(2, 'akaka', '2022-07-12 14:18:50', NULL, 4, 3, 3, 4, 4, '7'),
(9, 'qsdqsdqsdsq', '2022-07-07 12:08:00', NULL, 1, 11, 2, NULL, NULL, '4'),
(11, 'Oui Oui Oui', '2022-07-27 13:11:00', NULL, 1, 5, 4, NULL, NULL, '10'),
(12, NULL, '2022-07-29 16:02:00', NULL, 4, 6, 1, NULL, NULL, '17');
...
CREATE TABLE `t_d_supplier_spl` (
  ...
  `OHR_NUMBER` varchar(1024) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `t_d_supplier_spl` (`SPL_ID`, `SPL_NAME`, `OHR_NUMBER`) VALUES
(1, 'FOURNISSEUR1', NULL),
(2, 'FOURNISSEUR2', NULL),
(3, 'FOURNISSEUR3', NULL),
(4, 'FOURNISSEUR4', NULL),
(5, 'FOURNISSEUR5', NULL),
(6, 'Non renseigné', NULL);
...
(2, 3, 'sefqBZN@sfq.com', '2aa60a8ff7fcd473d321e0146afd9e26df395147', 'Bruno', 'Laporte', 4),
(3, 4, 'drgfagra@aerga.com', '1119cfd37ee247357e034a08d844eea25f6fd20f', 'Benoit', 'Gras', 4),
...
(13, NULL, 'ara@ara.fr', 'ee12558b79a93418c5742c7d2ba3d51c15b94fee', 'ara', 'ara', 3),
(14, NULL, '', 'da39a3ee5e6b4b0d3255bfef95601890afd80709', '', '', 1),
(15, NULL, '', '8b938e0d8975a2a40dba0b46ddc96bc45088c73d', '', 'qsdqsd', 1),
(16, NULL, 'oro@hotmail.fr', 'b198acf2721cf4451c40ecf5394a1803d684f6ef', 'oro', 'oro', 4),
(17, NULL, 'ere@hotmail.fr', 'b19d4e2e04b8175b5c127bcb0f6011dd93f21a04', 'ere', 'ere', 1);
...
--
ALTER TABLE `t_d_savfile_svf`
  MODIFY `SVF_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
