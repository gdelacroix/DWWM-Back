...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 04 juil. 2022 à 18:58
...
CREATE TABLE `t_d_diagsav_dsa` (
  ...
  `dsa_description` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `t_d_diagsav_dsa` (`dsa_ID`, `dsa_wording`, `dsa_description`) VALUES
...
CREATE TABLE `t_d_product_prd` (
  ...
  `PRD_warrantly` varchar(20) NOT NULL DEFAULT 'Garantie: 10ans.',
...
INSERT INTO `t_d_product_prd` (`PRD_ID`, `SPL_ID`, `PTY_ID`, `PRD_DESCRIPTION`, `PRD_warrantly`, `PRD_PICTURE`, `PRD_PRICE`, `PRD_CODE`) VALUES
(1, 1, 1, 'PRODUIT_1', 'Garantie 10ans', 'https://www.mistermenuiserie.com/media/catalog/product/m/m/mms-orleans-coulissant_1.png?optimize=low&fit=bounds&height=648&width=648&canvas=648:648&format=jpeg', '19.99', 'PRODUIT_1'),
(2, 2, 1, 'PRODUIT_2', 'Garantie 10ans', 'https://www.mistermenuiserie.com/media/catalog/product/m/m/mms-orleans-coulissant_1.png?optimize=low&fit=bounds&height=648&width=648&canvas=648:648&format=jpeg', '14.99', 'PRODUIT_2'),
(3, 3, 1, 'PRODUIT_3', 'Garantie 10ans', 'https://www.mistermenuiserie.com/media/catalog/product/m/m/mms-orleans-coulissant_1.png?optimize=low&fit=bounds&height=648&width=648&canvas=648:648&format=jpeg', '16.99', 'PRODUIT_3'),
(4, 1, 1, 'PRODUIT_4', 'Garantie 10ans', 'https://www.mistermenuiserie.com/media/catalog/product/m/m/mms-orleans-coulissant_1.png?optimize=low&fit=bounds&height=648&width=648&canvas=648:648&format=jpeg', '29.99', 'PRODUIT_4'),
(5, 2, 1, 'PRODUIT_5', 'Garantie 10ans', 'https://www.mistermenuiserie.com/media/catalog/product/m/m/mms-orleans-coulissant_1.png?optimize=low&fit=bounds&height=648&width=648&canvas=648:648&format=jpeg', '34.99', 'PRODUIT_5'),
(6, 4, 1, 'PRODUIT_6', 'Garantie 10ans', 'https://www.mistermenuiserie.com/media/catalog/product/m/m/mms-orleans-coulissant_1.png?optimize=low&fit=bounds&height=648&width=648&canvas=648:648&format=jpeg', '99.99', 'PRODUIT_6'),
(7, 5, 1, 'PRODUIT_7', 'Garantie 10ans', 'https://www.mistermenuiserie.com/media/catalog/product/m/m/mms-orleans-coulissant_1.png?optimize=low&fit=bounds&height=648&width=648&canvas=648:648&format=jpeg', '9.99', 'PRODUIT_7'),
(8, 1, 2, 'KIT_1', 'Garantie 10ans', NULL, '149.99', 'KIT_1'),
(9, 1, 2, 'KIT_2', 'Garantie 10ans', NULL, '89.99', 'KIT_2'),
(10, 2, 2, 'KIT_3', 'Garantie 10ans', NULL, '289.99', 'KIT_3'),
(11, 2, 2, 'KIT_4', 'Garantie 10ans', NULL, '199.99', 'KIT_4'),
(12, 1, 2, 'KIT_5', 'Garantie 10ans', NULL, '99.99', 'KIT_5'),
(13, 3, 2, 'KIT_6', 'Garantie 10ans', NULL, '399.99', 'KIT_6'),
(16, 6, 2, 'KIT_7', 'Garantie 10ans', NULL, '259.99', 'KIT_7'),
(17, 6, 2, 'KIT_8', 'Garantie 10ans', NULL, '109.99', 'KIT_8'),
(18, 6, 2, 'KIT_9', 'Garantie 10ans', NULL, '219.99', 'KIT_9');
