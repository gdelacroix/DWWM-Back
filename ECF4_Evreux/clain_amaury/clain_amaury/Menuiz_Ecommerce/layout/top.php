            ...
            <div class="container navbar-nav">
                ...
                <div class="navbar-collapse">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?= RACINE_WEB; ?>admin/detail-dossier-sav.php">
                                Detail dossier sav
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= RACINE_WEB; ?>admin/page-diagnostic.php">
                                Diagnostique
                            </a>
                        </li>
                        <li class="nav-item">
    ...
    <nav class="navbar navbar-expand-md navbar-light " style="background-color: #e3f2fd;">
        <div class="container navbar-nav">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= RACINE_WEB; ?>page-creation-dossier.php">Création dossier</a>
                </li>
