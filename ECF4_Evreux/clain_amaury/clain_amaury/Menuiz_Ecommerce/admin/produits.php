...
<table class="table_cat th_produits table table-striped">
    ...
    ?>
        <tr>
            ...
            <td>
                <a class="btn btn-primary" href="<?= RACINE_WEB; ?>admin/produit-edit.php?id=<?= $item['PRD_ID']; ?>">
                    Modifier
                </a>
                <a class="btn btn-danger" href="<?= RACINE_WEB; ?>admin/produit-delete.php?id=<?= $item['PRD_ID']; ?>" onclick="myFunction()">
                    Supprimer
                </a>
            </td>
        </tr>
