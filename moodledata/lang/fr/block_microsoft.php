...
$string['course_reset_do_nothing_team'] = 'Lorsque le parcours est réinitialisé, la connexion entre le parcours et l\'équipe restera. Toutes les modifications utilisateur apportées au cours seront synchronisées avec l\'équipe.';
