<?php class tel extends url{protected $classe = __CLASS__;static $compteur = 1;const TYPE = 'tel';function __construct( $param=NULL ){$this::$compteur++;parent::__construct( $param );if( $this->pattern === NULL ){$this->pattern = '[0-9]{4,12}';}
if( $this->maxlength === NULL ){$this->maxlength = 12;}}
