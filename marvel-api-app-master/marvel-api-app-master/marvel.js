    ...
    if (e.which == 13){
      ...
      var marvelAPI = {
        render: function() {
          ...
          // api url
          var url = `https://gateway.marvel.com/v1/public/characters?name=${toTitleCase(searchInput)}&ts=1&apikey=8dd756a18a2e358ccdc356558415ebf9&hash=7e4d87a949a11c6c7b1f829207083156`;
